...
def start_message(message):
    global data
    with open(r'Begin_Python\Homework\Homework_9\Task_1\data.json', encoding='utf-8') as json_file:
...
def comands_message(message):
    global data
    with open(r'Begin_Python\Homework\Homework_9\Task_1\data.json', 'rb') as json_file:
        data = json_file.read()
...
def check_message(message):
    ...
    if '/Добавить' in message.text:
        ...
        with open(r'Begin_Python\Homework\Homework_9\Task_1\data.json', 'w', encoding='utf-8') as outfile:
